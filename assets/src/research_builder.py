...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/style/navbar.css">
  <link rel="stylesheet" type="text/css" href="../assets/style/card.css">
...
nav_bar = '''
  <ul class="navbar">
   ...
   <li class="navbar"><a href="./interests.html">Interests</a></li>
...
<body>
  ...
  <div style="padding-top:10%;" class="hero">
  <h1>Research</h1>
  ...
  <a href="https://www.rand.org/content/dam/rand/pubs/research_reports/RR2000/RR2012/RAND_RR2012.pdf">
    <div class="card">
     <img class="card-right" src="../assets/img/RANDBODYCAM_image.png" alt="Avatar" style="float:right; position: relative; width: 20%;">
     <div class="container">
  ...
  <a href="https://www.nature.com/articles/srep39506">
    <div class="card">
     <img class="card-right" src="https://media.nature.com/m685/nature-assets/srep/2016/161222/srep39506/images/srep39506-f3.jpg" alt="Avatar" style="float:right; position: relative; width: 20%;">
     <div class="container">
  ...
  <a href="http://www.dtic.mil/get-tr-doc/pdf?AD=AD1021549">
    <div class="card">
     <img class="card-left" src="../assets/img/RANDDIA_image.png" alt="Avatar">
     <div class="container">
  ...
  <a href="https://www.rand.org/content/dam/rand/pubs/tools/TL100/TL186/RAND_TL186.pdf">
    <div class="card">
     <img class="card-left" src="../assets/img/cybsec_image.png" alt="Avatar">
     <div class="container">
  ...
  <a href="https://pubs.acs.org/doi/abs/10.1021/nn405826k">
    <div class="card">
     <img class="card-right" src="https://pubs.acs.org/appl/literatum/publisher/achs/journals/content/ancac3/2014/ancac3.2014.8.issue-1/nn405826k/production/images/medium/nn-2013-05826k_0005.gif" alt="Avatar" style="float:right; position: relative; width: 20%;">
     <div class="container">
  ...
  <a href="https://mdsoar.org/handle/11603/1878">
    <div class="card">
     <img class="card-left" src="../assets/img/PHOTOLUM_image.png" alt="Avatar">
     <div class="container">
  ...
  <a href="https://www.sciencedirect.com/science/article/pii/S016890021100012X">
    <div class="card">
     ...
     <div class="container">
       ...
       <p> The Sector 7 undulator beamline (7 ID) of the Advanced Photon Source (APS) is dedicated to time-resolved X-ray research [1]. Silicon avalanche photodiodes (APDs) are used as the primary point detector for time-resolved Bragg diffraction experiments for their fast recovery time (<100 ns) and ability to observe single photon events. For experiments with high photon ﬂux (≥105 photons/s) at the detector, however, deadtime corrections to the counting statistics become appreciable [2]. Common practice has been to attenuate the monochromatic beam entering the experimental hutch to an appropriately low ﬂux [3]. For these high-ﬂux experiments, an APD operated in proportional mode is a better detector choice due to a large dynamic range and linearity. With the ZT4212 ZTEC, EPICS based oscilloscope, the operating procedure to use an APD in proportional mode has been improved. This article shows the setup
     </p></div>
    </div>
  </a>
